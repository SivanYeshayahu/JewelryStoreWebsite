...
<section class="banner">
    <div class="banner-inner">
        <br>
        <br> <br> <br> <br>
        <h2>MY JEWELRY BOX </h2>
        <br> <br>  <br>
        <br> <br> <br>  <br>
        <h3>   ♡ SHOP NOW! ♡</h3>
        <h5>LIMITED TIME SALE! 30% OFF !!!!</h5>
        <h2><PERFECT COMBINATION ALL STORE 30%></h2>
...
<span style="color: #4b4949; font-size: 30px; font-family: Monospace "> DISCOVOR
    NEW PRODUCTS </span>
